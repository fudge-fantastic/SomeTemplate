export default function Cards() {
    ...
    return (
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 md:gap-4 gap-2 md:px-6 px-3 py-2">
            {cardData.map((card) => (
                <div key={card.title} className="hover-none md:hover:scale-105 duration-200 flex flex-col items-center justify-center bg-zinc-50 dark:bg-zinc-900 border border-zinc-950 rounded-md p-3 w-full text-center">
