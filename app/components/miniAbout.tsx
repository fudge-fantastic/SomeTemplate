    ...
    return (
        <div className="mx-3 md:mx-6 md:pt-2 pt-1">
            <div className="flex gap-4">
                ...
                <div className="md:text-justify text-xs md:text-sm text-justify dark:bg-zinc-900 border bg-zinc-50 border-zinc-950 py-2 px-4 rounded-lg sm:h-[210px] lg:h-[200px] lg:w-3/5">
                        <div>
